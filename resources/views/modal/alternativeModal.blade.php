      ...
      <div class="modal-body">
        <form action="{{route('criteria.store')}}" id="addForm" method="POST">
          ...
          <div class="form-group mb-3">
            ...
            <input required class="form-control" type="text" name="name" id="name" placeholder="Masukkan Alternatif" />
          </div>
      </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 class="text-center">Apakah anda yakin mengapus alternatif <span class="criteria-name"></span>?</h4>
      </div>
